...
open class ApiKeyAPI {
     ...
     */
    @discardableResult
    open class func deleteApiKey(id: Double, apiResponseQueue: DispatchQueue = PlomerSwiftSdkAPI.apiResponseQueue, completion: @escaping ((_ result: Swift.Result<DeleteAccount200Response, ErrorResponse>) -> Void)) -> RequestTask {
     ...
     */
    open class func deleteApiKeyWithRequestBuilder(id: Double) -> RequestBuilder<DeleteAccount200Response> {

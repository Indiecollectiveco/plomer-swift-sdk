...
/** Plomer Event represents a system message or alert for a user */
public struct PlomerEvent: Codable, JSONEncodable, Hashable {
...
extension PlomerEvent: Identifiable {}

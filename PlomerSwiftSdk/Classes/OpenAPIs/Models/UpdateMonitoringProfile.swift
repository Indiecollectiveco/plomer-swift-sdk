...
public struct UpdateMonitoringProfile: Codable, JSONEncodable, Hashable {
    ...
    public init(url: String? = nil, httpStatusChecks: Bool? = true, timeoutSeconds: Double? = 5, intervalSeconds: Double? = 30, healthyThresholdCount: Double? = 3, unhealthyThresholdCount: Double? = 5, domainExpiryCheck: Bool? = false, sslExpiryCheck: Bool? = false, contentChangeDetection: Bool? = false, description: String? = nil, tags: [String]? = nil, sendAlerts: Bool? = true) {
        self.url = url

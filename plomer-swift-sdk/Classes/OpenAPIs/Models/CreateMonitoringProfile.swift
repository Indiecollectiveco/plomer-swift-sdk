...
/** Input schema for creating a new monitoring profile */
public struct CreateMonitoringProfile: Codable, JSONEncodable, Hashable {
    ...
    public init(url: String, account: String, httpStatusChecks: Bool? = true, timeoutSeconds: Double? = nil, intervalSeconds: Double? = nil, healthyThresholdCount: Double? = nil, unhealthyThresholdCount: Double? = nil, domainExpiryCheck: Bool? = false, sslExpiryCheck: Bool? = false, contentChangeDetection: Bool? = false, description: String? = nil, tags: [String]) {
        self.url = url

...
```swift
    open class func addProfileToCollection(id: Double, profileId: Double, completion: @escaping (_ data: DeleteAccount200Response?, _ error: Error?) -> Void)
```
...
# **deleteCollection**
```swift
    open class func deleteCollection(id: Double, completion: @escaping (_ data: DeleteAccount200Response?, _ error: Error?) -> Void)
```
...
```swift
    open class func removeProfileFromCollection(id: Double, profileId: Double, completion: @escaping (_ data: DeleteAccount200Response?, _ error: Error?) -> Void)
```

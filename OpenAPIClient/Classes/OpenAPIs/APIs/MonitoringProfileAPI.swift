...
open class MonitoringProfileAPI {
     ...
     */
    @discardableResult
    open class func createMonitoringProfile(createMonitoringProfile: CreateMonitoringProfile? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: MonitoringProfile?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func createMonitoringProfileWithRequestBuilder(createMonitoringProfile: CreateMonitoringProfile? = nil) -> RequestBuilder<MonitoringProfile> {
        ...
        let localVariableRequestBuilder: RequestBuilder<MonitoringProfile>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func deleteMonitoringProfile(id: Double, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AddMacOsPushToken200Response?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func getMonitoringProfile(id: Double, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: MonitoringProfile?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func getMonitoringProfileRegistrarData(id: Double, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: RegistrarData?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getMonitoringProfileRegistrarDataWithRequestBuilder(id: Double) -> RequestBuilder<RegistrarData> {
        ...
        let localVariableRequestBuilder: RequestBuilder<RegistrarData>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getMonitoringProfileWhoisData(id: Double, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: WhoisData?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getMonitoringProfileWhoisDataWithRequestBuilder(id: Double) -> RequestBuilder<WhoisData> {
        ...
        let localVariableRequestBuilder: RequestBuilder<WhoisData>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getMonitoringProfiles(apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: [MonitoringProfile]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func updateMonitoringProfile(id: Double, updateMonitoringProfile: UpdateMonitoringProfile? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: MonitoringProfile?, _ error: Error?) -> Void)) -> RequestTask {

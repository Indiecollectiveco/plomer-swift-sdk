...
open class ApiKeyAPI {
     ...
     */
    @discardableResult
    open class func createApiKey(createApiKey: CreateApiKey? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ApiKey?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func createApiKeyWithRequestBuilder(createApiKey: CreateApiKey? = nil) -> RequestBuilder<ApiKey> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ApiKey>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func deleteApiKey(id: Double, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AddMacOsPushToken200Response?, _ error: Error?) -> Void)) -> RequestTask {
